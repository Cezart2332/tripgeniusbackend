        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromCoords = table.Column<double[]>(type: "double precision[]", nullable: false),
                    EndPoint = table.Column<string>(type: "text", nullable: false),
                    ToCoords = table.Column<double[]>(type: "double precision[]", nullable: false),
                    Note = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripTimelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripTimelines_Trips_TripId",
                        column: x => x.TripId,
